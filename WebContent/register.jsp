  ...
  <body style="background-color:#1c77ac; background-image:url(images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;"> 
    ...
    <div class="navbar">
        <div class="navbar-inner">
                ...
                <a class="brand" href="login.jsp"><span class="first">My</span> <span class="second">学生管理系统</span></a>
        </div>
    </div>
            ...
            <div class="block-body">
                <form onsubmit="return formCheck()" method="post" action="register">
                 ...
                 -->   
                    ...
                    <label><input type="checkbox" required>我同意<a style="color:red" href="RIGHT.jsp">条款</a></label>
